import person from '../../../assets/images/about_us/forhan.jpg';
    ...
    return (
        <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <img src={person} className="w-3/4 h-2/5 rounded-lg shadow-2xl border-8 border-white" />
                <img src={parts} className="w-3/5 absolute right-6 top-1/2 rounded-lg shadow-2xl border-8 border-white" />
                </div>
